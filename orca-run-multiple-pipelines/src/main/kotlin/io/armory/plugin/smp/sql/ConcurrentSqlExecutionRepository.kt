...
import com.netflix.spinnaker.orca.sql.pipeline.persistence.*
...
class ConcurrentSqlExecutionRepository(
    ...
    private fun retrieve(type: ExecutionType, criteria: ExecutionRepository.ExecutionCriteria, partition: String?): Observable<PipelineExecution> {
        withPool(poolName) {
